...
class SkinParserTests: XCTestCase {
  let fileURL = NSBundle(forClass: SkinParserTests.self).URLForResource("TestSkin", withExtension:"json")!
  ...
  func testControlbarConfig() {
     if let config:MovielalaPlayerConfig = SkinParser.parseConfigFromURL(fileURL) {
        ...
        XCTAssertEqual(config.controlbarConfig.timeTextColor, UIColor(hexString:"#ffff00"), "timeText tint color not equal")
        XCTAssertEqual(config.controlbarConfig.timeBackgroundColor, UIColor(hexString:"#ff00ff"), "timeLabel background color not equal")
        XCTAssertEqual(config.controlbarConfig.timeSliderBackgroundColor, UIColor(hexString:"#ff00ff"), "CustomTime Slider background color not equal")
        XCTAssertEqual(config.controlbarConfig.timeSliderThumbTintColor, UIColor(hexString:"#ffffff"), "CustomTime Slider thumb tint color not equal")
        XCTAssertEqual(config.controlbarConfig.timeSliderProgressTintColor, UIColor(hexString:"#ff0000"), "CustomTime Slider progress tint color not equal")
        XCTAssertEqual(config.controlbarConfig.timeSliderBufferTintColor, UIColor(hexString:"#555555"), "CustomTime Slider buffer tint color not equal")
        XCTAssertEqual(config.controlbarConfig.timeSliderRailTintColor, UIColor(hexString:"#ffff00"), "CustomTime Slider rail tint color not equal")
        XCTAssertEqual(
