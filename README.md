...
<*Screenshot here*>
```swift
playerVC.showOverlayViewController(BuyOverlayViewController(productID: productID))
```

### Show timed overlays
<*GIF here*>
```swift
for productPlacement in productsInVideo {
  playerVC.showOverlayViewController(
    BuyOverlayViewController(productID: productPlacement.productID),
    startingAtTime: productPlacement.startTime,
    forDuration: productPlacement.endTime - productPlacement.startTime)
}
```
...
<*GIF here*>
```swift
playerVC.prerollViewController = SponsorsOverlayViewController()
```

### Pause overlays
<*GIF here*>
```swift
playerVC.pauseOverlayViewController = InfoAndBuyOverlayViewController(productID: productID)
```

### Post-roll
<*GIF here*>
```swift
playerVC.postrollViewController = InfoAndBuyOverlayViewController(productID: productID)
```
